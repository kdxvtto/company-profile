            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div className="text-center mb-16">
                    <div className="inline-block">
                        ...
                        <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                            BANK <span className="text-blue-600">WONOGIRI</span>
                        </h2>
                    ...
                    <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                        ...
                        <span className="font-semibold text-blue-600">100% sahamnya milik Pemkab Wonogiri</span>.
                    </p>
                </div>
                ...
                <div className="mt-16 text-center">
                    <div className="inline-flex items-center gap-3 bg-blue-50 px-6 py-3 rounded-full">
                        ...
                        <span className="text-blue-700 font-medium">Melayani masyarakat Wonogiri sejak tahun 1982</span>
                    </div>
                </div>
            </div>
        </section>
